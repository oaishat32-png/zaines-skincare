...
const Hero: React.FC = () => {
  ...
  const handlePrimaryClick = () => {
    if (slides[currentSlide].primaryLink.startsWith("#")) {
      const target = document.querySelector(
        slides[currentSlide].primaryLink
      );
      ...
      window.location.href = slides[currentSlide].primaryLink;
    }
  };

  // Handle secondary button
  const handleSecondaryClick = () => {
    if (slides[currentSlide].secondaryLink.startsWith("#")) {
      const target = document.querySelector(
        slides[currentSlide].secondaryLink
      );
      ...
      window.location.href = slides[currentSlide].secondaryLink;
    }
  };
        ...
        >
          ...
          <div className="mt-7 flex w-full flex-col gap-3 sm:mt-9 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center rounded-full bg-[#EAA900] px-6 py-3 text-xs font-semibold uppercase tracking-wide text-[#1d1914] shadow-lg shadow-black/10 transition-all duration-300 hover:-translate-y-1 hover:bg-[#F5C542] hover:shadow-xl sm:w-auto sm:px-7 sm:py-3.5 sm:text-sm"
            >
              {slide.primaryButton}
            </button>
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center rounded-full border border-white/60 bg-white/10 px-6 py-3 text-xs font-semibold uppercase tracking-wide text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white hover:bg-white hover:text-[#1d1914] sm:w-auto sm:px-7 sm:py-3.5 sm:text-sm"
            >
